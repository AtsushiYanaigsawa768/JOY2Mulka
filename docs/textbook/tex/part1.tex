...
\textbf{事前準備の印刷（スタートリスト・役職用リスト・チェックリスト）は，
...
クラスごとの設定は，クラスリストの右にあるボタンから\textbf{一括入力}できます。\ver
...
コースやクラスの情報は，イベントマネージャの画面から 1 つずつ入れられますが，
\textbf{コース数が多いときや，同じ直しを何十行も繰り返すとき}は，
